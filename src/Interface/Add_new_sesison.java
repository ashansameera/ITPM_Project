...
public class Add_new_sesison extends javax.swing.JFrame {
    ...
    private void fillcombox2(){
     ...
     private void fillcombox3(){
       ...
       private void fillcombox4(){
        ...
        while (rs.next()){
        String room = rs.getString("Lecture_Name");
        c6.addItem(room);
        }
        }catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String end_t = jTextField5.getText();
          ...
          if(jTextField1.getText().toString().equals("")){
            ...
            String Studnet = jTextField1.getText().toString();
            String Duration = jTextField2.getText().toString();
         try{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       Session_manegement s1 = new Session_manegement();
       s1.setVisible(true);
       this.dispose();
